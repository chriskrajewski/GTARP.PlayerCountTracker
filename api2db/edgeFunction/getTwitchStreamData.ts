...
const SEARCH_CONFIG = [
  { serverId: "o3re8y", keyword: "unscripted" },
  { serverId: "46pb7q", keyword: "onx" },
  { serverId: "3lamjz", keyword: "nopixel" },
  { serverId: "9mxzbe", keyword: "prodigy" },
  { serverId: "l7o9o4", keyword: "district 10" },
  { serverId: "7pkv5d", keyword: "SmileRP" },
  { serverId: "k8px4v", keyword: "Time2RP" },
  { serverId: "vqkmaq", keyword: "unscripted public" },
  { serverId: "wmev57", keyword: "newdayrp" },
  { serverId: "77qvev", keyword: "rebirth" },
  { serverId: "r8q73g", keyword: "nopixel public" },
  { serverId: "775kda", keyword: "prodigy public" },
  { serverId: "68oab8", keyword: "echorp" },
  { serverId: "ak44p9", keyword: "free2rp" }
];
...
async function getTwitchOAuthToken(clientId: string, clientSecret: string) {
...
async function getGameId(clientId: string, token: string, gameName: string) {
...
async function getStreams(
  ...
  token: string,
  gameId: string,
  { serverId, keyword }: { serverId: string; keyword: string }
) {
  const headers = {
    "Client-ID": clientId,
    "Authorization": `Bearer ${token}`
...
async function logToSupabase(
  ...
  for (const row of streams) {
    const { error } = await supabaseClient.from("twitch_streams").insert(row);
